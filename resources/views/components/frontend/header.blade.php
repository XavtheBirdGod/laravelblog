                ...
                <div class="col-12 col-md-6">
                    <div class="breaking-news-area">
                        ...
                        <div id="breakingNewsTicker" class="ticker">
                            <ul>
                                <li><a href="#">Welkom op onze Laravel
                                        blogfrontend.</a></li>
                                <li><a href="#">We zetten de Gazette
                                        homepagina stap voor stap om.</a></li>
                                <li><a href="#">Nieuwe artikels verschijnen
                                        hier automatisch.</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
